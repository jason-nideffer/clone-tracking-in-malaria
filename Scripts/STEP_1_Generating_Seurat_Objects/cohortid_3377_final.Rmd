...
run_directory <- "3528_3377_R1"
rna_directories <- c('S3','S4','S5') # List the RNAseq directory names you want to analyze
tcr_directories <- c('S3','S4','S5') # List the TCR directory names you want to analyze in order that corresponds to 'cite_directories'
...
```{r}
unstimulated_cutoffs <- c(0.65, 0.65, 0.6)
iRBCs_cutoffs <-        c(0.4,  0.5,  0.8)
