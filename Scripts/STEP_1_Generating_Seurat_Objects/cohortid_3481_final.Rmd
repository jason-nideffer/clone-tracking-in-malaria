...
run_directory <- "3481_T1-T7_RNA-TCR"
rna_directories <- c('T1','T2','T3','T5','T6','T7') # List the RNAseq directory names you want to analyze
tcr_directories <- c('T1','T2','T3','T5','T6','T7') # List the TCR directory names you want to analyze in order that corresponds to 'cite_directories'
cohortid <- "3481"
...
for (i in 1:length(rna_directories)) {
  ...
  seurat_object@meta.data$timepoint <- rna_directories[i]
...
```{r}
unstimulated_cutoffs <- c(0.9, 0.65, 0.5, 0.4, 0.5, 0.6)
iRBCs_cutoffs <-        c(0.4, 0.5,  0.5, 0.7, 0.6, 0.7)
...
for (i in 1:length(cohortid_timepoints)) {
  ...
  colnames(data_for_plot) <- c(NA,NA,'unstimulated','iRBCs')
...
for (i in 1:length(cohortid_timepoints)) {
  ...
  colnames(data_for_subsetting) <- c(NA,NA,'unstimulated','iRBCs')
...
max_features <- c(4000, 4000, 4000, 4500, 4500, 4000)
