...
rna_directories <- c('S1','S2','S3','S4') # List the RNAseq directory names you want to analyze
tcr_directories <- c('S1','S2','S3','S4') # List the TCR directory names you want to analyze in order that corresponds to 'cite_directories'
...
```{r}
unstimulated_cutoffs <- c(0.7, 0.8, 1.5, 0.65)
iRBCs_cutoffs <-        c(1.0, 1.0, 0.7, 1.2)
bead_cutoffs <-         c(1.0, 1.0, 1.0, 1.2)
