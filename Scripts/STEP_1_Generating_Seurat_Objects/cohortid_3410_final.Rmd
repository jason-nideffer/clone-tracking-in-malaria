...
run_directory <- "3410_T1-T4_RNA-TCR"
rna_directories <- c('T1','T2','T3','T4') # List the RNAseq directory names you want to analyze
tcr_directories <- c('T1','T2','T3','T4')  # List the TCR directory names you want to analyze in order that corresponds to 'cite_directories'
...
```{r}
unstimulated_cutoffs <- c(0.7, 0.65,  0.6, 1.0)
iRBCs_cutoffs <-        c(0.7, 0.75,  0.8, 1.2)
bead_cutoffs <-         c(0.8,  0.8,  0.8, 1.2)
